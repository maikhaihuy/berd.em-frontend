# staff-shift-history Specification

## Purpose

Lets a logged-in Staff member see their own completed shift history for the week at a glance —
the Bản ký tab of Lịch ca — reusing the shared weekly period-band grid also used for viewing
upcoming shifts.
